...
function maruderm_resolve_product(string $slug, string $language = 'uk'): ?array
{
    ...
    return [
        ...
        'images' => $images,
        'highlights' => $translator->strings($content->highlights($product), $language),
        'fullIngredients' => $translator->text($content->fullIngredients($product), $language),
        'netWeight' => $translator->text($content->netWeight($product), $language),
        'boxDimensions' => $translator->text($content->boxDimensions($product), $language),
        'origin' => $translator->text($content->origin($product), $language),
        'shelfLife' => $translator->text($content->shelfLife($product), $language),
        'benefits' => $translator->pairs($content->benefits($product), $language),
        'ingredients' => $translator->pairs($content->ingredients($product), $language),
        'formula' => $translator->text($content->formula($product), $language),
        'routine' => $translator->pairs($content->routine($product), $language),
        'review' => $review,
        'related' => array_map(
