...
class UkrPoshtaShipping extends AbstractShippingMethod
{
    public function __construct($instance_id = 0)
    {
        ...
        $this->method_title = __('Ukrposhta', 'wc-ukr-shipping');
    ...
    public function init_form_fields(): void
    {
        $this->instance_form_fields = [
            'title' => [
                ...
                'type' => 'text',
                'description' => '',
                'default' => __('Ukrposhta', 'wc-ukr-shipping') . ' ' . __($this->get_option('service_type'), 'wc-ukr-shipping'),
            ],
            'service_type' => [
                'title' => __('Type of shipment', 'wc-ukr-shipping'),
                'type' => 'select',
                'description' => '',
                'default' => 'EXPRESS',
                'options' => [
                    'STANDARD' => __('STANDARD', 'wc-ukr-shipping'),
                    'EXPRESS'  => __('EXPRESS', 'wc-ukr-shipping'),
                ],
            ],
            ...
            'send_dimensions' => [
                'label' => __('Send dimensions when calculating shipping cost', 'wc-ukr-shipping'),
                'type' => 'checkbox',
                'description' => __('If checked and function supported by carrier, the product dimensions will be send to rates api.', 'wc-ukr-shipping'),
                'default' =>  'no',
                'desc_tip' => true,
                'class' => 'j-wcus-shipping-option-cod',
            ],
    ...
    protected function getCheckoutRateShipmentFactory(): CheckoutRateShipmentFactory
    {
        return new UkrposhtaCheckoutRateShipmentFactory(
            ...
            'warehouse',
            $this->get_option('send_dimensions') === 'yes'
        );
    }
}
