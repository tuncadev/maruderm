...
class MeestAddressShipping extends AbstractShippingMethod
{
    public function __construct($instance_id = 0)
    {
        ...
        $this->method_title = __('Meest Post Address', 'wc-ukr-shipping');
        $this->method_description = 'Meest Post Address by SmartyParcel';
    ...
    public function init_form_fields(): void
    {
        $this->instance_form_fields = [
            'title' => [
                ...
                'type' => 'text',
                'description' => '',
                'default' => __('Meest Post Address', 'wc-ukr-shipping'),
            ],
