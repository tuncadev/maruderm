...
class NovaPoshtaShipping extends AbstractShippingMethod
{
    ...
    public function init_form_fields(): void
    {
        ...
        $this->instance_form_fields = [
            ...
            'delivery_methods' => [
                'title' => __('Delivery types', 'wc-ukr-shipping'),
                'type' => 'multiselect',
                'options' => [
                    'warehouse' => __('To warehouse', 'wc-ukr-shipping'),
                    'doors'  => __('By courier', 'wc-ukr-shipping'),
                    'poshtomat'  => __('To poshtomat', 'wc-ukr-shipping'),
                ],
            ...
            'combine_poshtomats' => [
                'label' => __('Combine poshtomats and warehouses', 'wc-ukr-shipping'),
                'type' => 'checkbox',
