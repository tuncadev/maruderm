        ...
        <div class="wcus-card">
            <div class="wcus-card__content">
                ...
                <div class="wcus-pro-features__list">
                    ...
                    <div class="wcus-pro-features__feature">
                        <?php esc_html_e('More carrier accounts', 'wc-ukr-shipping'); ?>
                    </div>
                    <div class="wcus-pro-features__feature">
                        <?php esc_html_e('Automatic calculation of shipping costs.', 'wc-ukr-shipping'); ?>
                    </div>
                    <div class="wcus-pro-features__feature">
                        <?php esc_html_e('Shipping calculation based on order total', 'wc-ukr-shipping'); ?>
                    </div>
                    <div class="wcus-pro-features__feature">
                        <?php esc_html_e('Possibility of mass generation of TTN in one click', 'wc-ukr-shipping'); ?>
                    </div>
                    <div class="wcus-pro-features__feature">
