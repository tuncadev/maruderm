...
/**
 * Class WC_Keycrm_WC_Customer_Builder
 * It converts keyCRM customer data (array) into WC_Customer
 */
class WC_Keycrm_WC_Customer_Builder extends WC_Keycrm_Abstract_Builder
{
    /**
    ...
    /**
     * WC_Keycrm_WC_Customer_Builder constructor.
     */
    ...
    /**
     * Fill WC_Customer fields with customer data from keyCRM.
     * If field is not present in keyCRM customer - it will remain unchanged.
     *
    ...
    public function build()
    {
        ...
        WC_Keycrm_Logger::debug(__METHOD__, array('Building WC_Customer from data:', $this->data));
