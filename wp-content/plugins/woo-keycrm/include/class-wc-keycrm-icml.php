...
if ( ! class_exists( 'WC_Keycrm_Icml' ) ) :
    ...
    class WC_Keycrm_Icml
    {
        ...
        /**
         * WC_Keycrm_Icml constructor.
         *
         */
        public function __construct()
        {
            $this->settings = get_option(WC_Keycrm_Base::$option_key);
        ...
        private function setOffer(&$full_product_list, $product_attributes, $product, $parent = false) {
            ...
            if ($product->get_sku() != '') {
                ...
                if (isset($this->settings['bind_by_sku']) && $this->settings['bind_by_sku'] == WC_Keycrm_Base::YES) {
        ...
        private function checkPostStatuses() {
            ...
            foreach (get_post_statuses() as $key => $value) {
                if (isset($this->settings['p_' . $key]) && $this->settings['p_' . $key] == WC_Keycrm_Base::YES) {
                    $status_args[] = $key;
                }
            }
