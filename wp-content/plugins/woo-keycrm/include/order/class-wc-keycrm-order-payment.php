...
/**
 * Class WC_Keycrm_Order_Payment
 */
class WC_Keycrm_Order_Payment extends WC_Keycrm_Abstracts_Data
{
    /** @var string  */
    ...
    /**
     * WC_Keycrm_Order_Item constructor.
     *
    ...
    public function build($order, $externalId = false)
    {
        ...
        $data['status'] = getPaymentStatus_kcrm($order);
        $data['paidAt'] = getPaymentDate_kcrm($order);
