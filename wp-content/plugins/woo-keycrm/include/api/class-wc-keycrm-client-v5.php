 ...
 * @link     http://keycrm.app/docs/Developers/ApiVersion5
 */
...
class WC_Keycrm_Client_V5
{
    ...
    public function __construct($url, $apiKey, $version = null, $site = null)
    {
        ...
        $this->client = new WC_Keycrm_Request($url, array('apiKey' => $apiKey));
        $this->unversionedClient = new WC_Keycrm_Request($unversionedUrl, array('apiKey' => $apiKey));
        $this->siteCode = $site;
    }
    ...
    {
        return $this->unversionedClient->makeRequest('/api-versions', WC_Keycrm_Request::METHOD_GET);
    }
    ...
    {
        return $this->unversionedClient->makeRequest('/credentials', WC_Keycrm_Request::METHOD_GET);
    }
    ...
    {
        return $this->client->makeRequest("/users/$id", WC_Keycrm_Request::METHOD_GET);
    }
