 ...
 * @package  WC_Keycrm_Response
 * @author   KeyCRM <dev@keycrm.app>
 * @license  https://opensource.org/licenses/MIT MIT License
 */

if ( ! class_exists( 'WC_Keycrm_Exception_Json' ) ) {
    include_once(WC_Integration_Keycrm::checkCustomFile('include/api/class-wc-keycrm-exception-json.php'));
}


class WC_Keycrm_Response implements \ArrayAccess
{
    ...
    public function __construct($statusCode, $responseBody = null)
    {
        ...
        if (!empty($responseBody)) {
            ...
            if (!$response && JSON_ERROR_NONE !== ($error = json_last_error())) {
                throw new WC_Keycrm_Exception_Json(
