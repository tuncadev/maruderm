...
/**
 * Class WC_Keycrm_Paginated_Request
...
class WC_Keycrm_Paginated_Request
{
    ...
    /**
     * WC_Keycrm_Paginated_Request constructor.
     */
    ...
    /**
     * Sets keyCRM api client to request
     *
     * @param \WC_Keycrm_Proxy|\WC_Keycrm_Client_V6 $api
     *
     * @return self
     */
    ...
    public function execute()
    {
        ...
        do {
            ...
            if ($response instanceof WC_Keycrm_Response && $response->offsetExists($this->dataKey)) {
