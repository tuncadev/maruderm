...
/**
 * Class WC_Keycrm_History_Assembler
...
class WC_Keycrm_History_Assembler
{
    ...
    public static function assemblyCustomer($customerHistory)
    {
        ...
        foreach ($customerHistory as $change) {
            ...
            // `Y-m-d H:i:s` format if customer was marked as unsubscribed in keyCRM
    ...
    /**
     * Returns mapping data for keyCRM entities. Used to assembly entities from history.
     *
    ...
    {
        $fields = array();
        $mappingFile = realpath(WC_Integration_Keycrm::checkCustomFile('config/objects.xml'));
