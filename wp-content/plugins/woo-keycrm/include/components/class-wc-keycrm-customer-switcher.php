...
/**
 * Class WC_Keycrm_Customer_Switcher
 * This component provides builder-like interface in order to make it easier to change customer & customer data
 * in the order via keyCRM history.
 */
class WC_Keycrm_Customer_Switcher implements WC_Keycrm_Builder_Interface
{
    /**
     * @var \WC_Keycrm_Customer_Switcher_State $data
     */
    private $data;

    /**
     * @var \WC_Keycrm_Customer_Switcher_Result|null $result
     */
    private $result;

    /**
     * WC_Keycrm_Customer_Data_Replacer constructor.
     */
    ...
    public function build()
    {
        ...
        WC_Keycrm_Logger::debug(__METHOD__, array('state', $this->data));
    ...
    public function processChangeToRegular($wcOrder, $newCustomer, $isContact)
    {
        ...
        if (isset($newCustomer['externalId'])) {
            $wcCustomer = WC_Keycrm_Plugin::getWcCustomerById($newCustomer['externalId']);
        ...
        $this->result = new WC_Keycrm_Customer_Switcher_Result($wcCustomer, $wcOrder);
    }
    ...
    protected function processCompanyAddress()
    {
        ...
        if (empty($this->result)) {
            $this->result = new WC_Keycrm_Customer_Switcher_Result(null, $wcOrder);
        }
    }
    ...
    public function processCompanyChange()
    {
        ...
        if (empty($this->result)) {
            $this->result = new WC_Keycrm_Customer_Switcher_Result(null, $this->data->getWcOrder());
        }
    }
    ...
    {
        $this->data = new WC_Keycrm_Customer_Switcher_State();
        $this->result = null;
        return $this;
    }
    ...
    {
        if (!($data instanceof WC_Keycrm_Customer_Switcher_State)) {
    ...
    /**
     * @return \WC_Keycrm_Customer_Switcher_Result|null
     */
    ...
    /**
     * @return \WC_Keycrm_Customer_Switcher_State
     */
