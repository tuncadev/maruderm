...
if (!class_exists('WC_Keycrm_Logger') && class_exists('WC_Log_Levels')):
    /**
     * Class WC_Keycrm_Logger
     */
    class WC_Keycrm_Logger
    {
        /** @var string */
         ...
         * This log will work only if debug mode is enabled (see keycrm_is_debug() for details).
