	...
	private function select_demo_page() {
        ...
        <div class="wrap">
            ...
            <div class="updated notice is-dismissible">
                ...
                <p>
                    <strong><?php _e( 'Important: you need to choose a demo is correct with the page builder(WPBakery or Elementor) plugin you installed.', 'soodi' ) ?></strong>
                </p>
            ...
            <div class="martfury-tabs">
                <ul class="tabs-nav">
                    <li><a href="#" class="active"><?php esc_html_e( 'Elementor Demo', 'martfury' ); ?></a></li>
                    <li><a href="#"><?php esc_html_e( 'WPBakery Demo', 'martfury' ); ?></a></li>
                </ul>
