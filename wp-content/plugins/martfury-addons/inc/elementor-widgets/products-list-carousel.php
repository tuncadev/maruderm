...
class Products_List_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products List Carousel', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'rows',
			[
				'label'   => esc_html__( 'Rows', 'martfury-addons' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'3' => esc_html__( '3 Rows', 'martfury-addons' ),
					'4' => esc_html__( '4 Rows', 'martfury-addons' ),
					'5' => esc_html__( '5 Rows', 'martfury-addons' ),
					'6' => esc_html__( '6 Rows', 'martfury-addons' ),
				],
				'default' => '4',
				'toggle'  => false,
			]
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'yes' => esc_html__( 'Show', 'martfury-addons' ),
					'no'  => esc_html__( 'Hide', 'martfury-addons' ),
				],
				'default' => 'yes',
				'toggle'  => false,
			]
		...
		$this->add_responsive_control(
			'sliders_dots_space',
			[
				'label'     => esc_html__( 'Dots Spacing', 'martfury-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => -30,
