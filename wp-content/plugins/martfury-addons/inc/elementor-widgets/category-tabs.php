...
class Category_Tabs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Category Tabs', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title', [
				...
				'default'     => esc_html__( 'Search Trending', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'subtitle', [
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Updated at 9:00AM', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		$this->start_controls_section(
			...
			[ 'label' => esc_html__( 'Hot Trending', 'martfury-addons' ) ]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'icons'        => esc_html__( 'Default Icons', 'martfury-addons' ),
					'custom_icons' => esc_html__( 'Custom Icon', 'martfury-addons' ),
				],
				'default' => 'icons',
				'toggle'  => false,
			]
		...
		$this->add_control(
			'title_hot_trending', [
				'label'       => esc_html__( 'Title', 'martfury-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Hot Trending', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		if ( $count > 0 ) {
			for ( $i = 1; $i <= $count; $i ++ ) {
				$this->start_controls_section(
					'section_content_' . $i,
					[ 'label' => sprintf( '%s %s', esc_html__( 'Category Tab', 'martfury-addons' ), $i ) ]
				);
				...
				$this->add_control(
					'tab_title_' . $i, [
						'label'       => esc_html__( 'Title', 'martfury-addons' ),
						'type'        => Controls_Manager::TEXT,
						'default'     => sprintf( '%s #%s', esc_html__( 'Tab', 'martfury-addons' ), $i ),
						'label_block' => true,
					]
				);
				...
				$repeater->add_control(
					'title_tag', [
						'label'       => esc_html__( 'Title', 'martfury-addons' ),
						'type'        => Controls_Manager::TEXT,
						'default'     => esc_html__( '#tag1', 'martfury-addons' ),
						'label_block' => true,
					]
				);
				...
				$this->add_control(
					'tags_' . $i,
					[
						'label'         => esc_html__( 'Tags', 'martfury-addons' ),
	...
	protected function register_heading_style_controls() {
		...
		$this->start_controls_tab( 'heading_tab_title', [ 'label' => esc_html__( 'Title', 'martfury-addons' ) ] );
		...
		$this->start_controls_tab( 'heading_tab_subtitle', [ 'label' => esc_html__( 'Subtitle', 'martfury-addons' ) ] );
	...
	protected function register_tab_header_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Header', 'martfury-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'show_button',
			[
				'label'     => esc_html__( 'Show Tab Header', 'martfury-addons' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
		...
		$this->start_controls_tab( 'tab_header_normal', [ 'label' => esc_html__( 'Normal Item', 'martfury-addons' ) ] );
		...
		$this->start_controls_tab( 'tab_header_active', [ 'label' => esc_html__( 'Active Item', 'martfury-addons' ) ] );
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Bottom Width', 'martfury-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'unit' => 'px',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'SVG Font Size', 'martfury-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => 40,
				],
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Previous Position', 'martfury-addons' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', 'em', '%' ],
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Next Position', 'martfury-addons' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', 'em', '%' ],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Disabled Text Color', 'martfury-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
	...
	protected function register_tab_content_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Content', 'martfury-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_group_control(
			...
			[
				'label'     => esc_html__( 'Image Size', 'martfury-addons' ),
				'name'      => 'image',
				'default'   => 'full',
				'separator' => 'none',
			]
