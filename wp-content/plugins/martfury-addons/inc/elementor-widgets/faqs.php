...
class FAQs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'FAQs', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[ 'label' => esc_html__( 'FAQs', 'martfury-addons' ) ]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'FAQs Title', 'martfury-addons' ),
				'placeholder' => esc_html__( 'Enter FAQs title', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'       => esc_html__( 'Title', 'martfury-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'This is the question', 'martfury-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'This is the answer', 'martfury-addons' ),
				'placeholder' => esc_html__( 'Enter your title', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'       => [
					[
						'title' => esc_html__( 'This is the question #01', 'martfury-addons' ),
						'desc'  => esc_html__( 'This is the answer #01. Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
					],
					[
						'title' => esc_html__( 'This is the question #02', 'martfury-addons' ),
						'desc'  => esc_html__( 'This is the answer #02. Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
					],
					[
						'title' => esc_html__( 'This is the question #03', 'martfury-addons' ),
						'desc'  => esc_html__( 'This is the answer #03. Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
					]
				],
				'title_field'   => '{{{ title }}}',
				'prevent_empty' => false
