...
class Contact_Form_7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'form',
			[
				'label'   => esc_html__( 'Contact Form', 'martfury-addons' ),
	...
	protected function get_contact_form() {
		$mail_forms    = get_posts( array( 'post_type' => 'wpcf7_contact_form', 'posts_per_page' => 100, 'orderby' => 'title', 'order' => 'ASC' ) );
		$mail_form_ids = array(
