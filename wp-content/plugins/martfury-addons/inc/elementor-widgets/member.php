...
class Member extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Member', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Robert Downey Jr', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'CEO Founder', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					'icon'        => esc_html__( 'Old Icon', 'martfury-addons' ),
					'custom_icon' => esc_html__( 'New Icon', 'martfury-addons' ),
				],
				'default' => 'icon',
				'toggle'  => false,
			]
		...
		$this->add_control(
			'socials',
			[
				'label'         => esc_html__( 'Socials', 'martfury-addons' ),
		...
		$this->add_control(
			'opacity',
			[
				'label'     => esc_html__( 'Opacity', 'martfury-addons' ),
		...
		$position = [
			'top'    => esc_html__( 'Top', 'martfury-addons' ),
			'right'  => esc_html__( 'Right', 'martfury-addons' ),
			'bottom' => esc_html__( 'Bottom', 'martfury-addons' ),
		...
		$this->add_responsive_control(
			'social_gap',
			[
				'label'     => esc_html__( 'Gaps', 'martfury-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [],
				'range'     => [
					'px' => [
