...
class Journey extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Journey', 'martfury-addons' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'year',
			[
				'label'       => esc_html__( 'Year', 'martfury-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( '2019', 'martfury-addons' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'January 2019', 'martfury-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
		...
		$repeater->add_control(
			'reverse',
			[
				'label'     => esc_html__( 'Reverse', 'martfury-addons' ),
			...
			[
				...
				'default'       => [
					[
						...
						'title'   => esc_html__( 'January 2010', 'martfury-addons' ),
						'desc'    => esc_html__( 'Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
						'reverse' => 'no'
					...
					[
						...
						'title'   => esc_html__( 'January 2012', 'martfury-addons' ),
						'desc'    => esc_html__( 'Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
						'reverse' => 'no'
					...
					[
						...
						'title'   => esc_html__( 'January 2016', 'martfury-addons' ),
						'desc'    => esc_html__( 'Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
						'reverse' => 'no'
					...
					[
						...
						'title'   => esc_html__( 'January 2018', 'martfury-addons' ),
						'desc'    => esc_html__( 'Sed elit quam, iaculis sed semper sit amet udin vitae nibh. at magna akal semperFusce commodo molestie', 'martfury-addons' ),
						'reverse' => 'yes'
		...
		$this->start_controls_section(
			...
			[
				'label' =>esc_html__( 'Timeline', 'martfury-addons' ),
