...
namespace Martfury\Addons\Elementor\Controls;
...
class AjaxLoader {
	...
	public function __construct() {
		// Get Autocomplete
		add_action( 'wp_ajax_mf_get_autocomplete_suggest', [ $this, 'mf_get_autocomplete_suggest' ] );
		add_action( 'wp_ajax_mf_get_autocomplete_render', [ $this, 'mf_get_autocomplete_render' ] );
	}
	 ...
	 * @return void
	 */
	public function mf_get_autocomplete_suggest() {
		$result = [];

		$source = $_POST && isset( $_POST['source'] ) ? $_POST['source'] : '';

		if ( ! empty( $source ) ) {
			$result = call_user_func( array( $this, 'mf_autocomplete_' . $source . '_callback' ) );
		}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_product_cat_callback() {
		return $this->mf_autocomplete_taxonomy_callback( 'product_cat' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_product_tag_callback() {
		return $this->mf_autocomplete_taxonomy_callback( 'product_tag' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_product_brand_callback() {
		return $this->mf_autocomplete_taxonomy_callback( 'product_brand' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_product_author_callback() {
		return $this->mf_autocomplete_taxonomy_callback( 'product_author' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_product_callback() {
		return $this->mf_autocomplete_post_type_callback( 'product' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_post_callback() {
		return $this->mf_autocomplete_post_type_callback( 'post' );
	}
	 ...
	 * @return array
	 */
	public function mf_autocomplete_category_callback() {
		return $this->mf_autocomplete_taxonomy_callback( 'category' );
	}
		...
		foreach ( $terms as $term ) {
			...
			$data[] = sprintf(
				'<li class="mf_autocomplete-label" data-value="%s">
					...
					<a href="#" class="mf_autocomplete-remove">&times;</a>
				</li>',
				esc_attr( $term->slug ),
