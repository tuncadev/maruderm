...
if ( ! class_exists( 'Martfury_Widget_Product_Tag_Cloud' ) ) {
	...
	class Martfury_Widget_Product_Tag_Cloud extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Your most used product tags in cloud format.', 'martfury-addons' );
			$this->widget_id          = 'martfury_product_tag_cloud';
			$this->widget_name        = esc_html__( 'Martfury Product Tags', 'martfury-addons' );
			$this->settings           = array(
				'title'   => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Product Tags', 'martfury-addons' ),
		...
		protected function get_page_base_url( $taxonomy ) {
			if ( defined( 'SHOP_IS_ON_FRONT' ) ) {
				...
				$link = get_term_link( get_query_var( 'product_brand' ), 'product_brand' );
