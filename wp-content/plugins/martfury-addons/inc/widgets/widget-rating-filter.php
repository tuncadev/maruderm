...
if( ! class_exists('Martfury_Widget_Rating_Filter') ) {
	...
	class Martfury_Widget_Rating_Filter extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a list of star ratings to filter products in your store.', 'martfury-addons' );
			$this->widget_id          = 'martfury_rating_filter';
			$this->widget_name        = esc_html__( 'Martfury - Filter Products by Rating', 'martfury-addons' );
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Average rating', 'martfury-addons' ),
