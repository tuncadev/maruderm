...
require_once __DIR__ . '/WooCommerce/ProductImageRepository.php';
require_once __DIR__ . '/WooCommerce/ProductAssets.php';
require_once __DIR__ . '/WooCommerce/ProductGoodFor.php';
require_once __DIR__ . '/WooCommerce/ProductCardPromotion.php';
require_once __DIR__ . '/WooCommerce/ProductIngredients.php';
require_once __DIR__ . '/WooCommerce/ProductOrdering.php';
require_once __DIR__ . '/WooCommerce/HeaderMiniCart.php';
...
require_once __DIR__ . '/Layout/StorefrontTranslations.php';
...
\Maruderm\WooCommerce\ProductAssets::load();
\Maruderm\WooCommerce\ProductGoodFor::load();
\Maruderm\WooCommerce\ProductIngredients::load();
\Maruderm\WooCommerce\ProductOrdering::load();
\Maruderm\WooCommerce\HeaderMiniCart::load();
...
\Maruderm\Layout\StorefrontTranslations::load();
