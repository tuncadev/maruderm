...
function martfury_enqueue_scripts() {
	...
	wp_register_script( 'waypoints', get_template_directory_uri() . '/js/plugins/waypoints.min.js', array( 'jquery' ), '2.0.2', true );
	...
	if ( is_singular( 'product' ) ) {
		...
		if( intval(martfury_get_option('product_360_view')) ) {
	...
	if ( intval( martfury_get_option( 'added_to_compare_notice' ) ) && shortcode_exists( 'wcboost_compare_button' ) ) {
		if( shortcode_exists( 'wcboost_compare_button' ) ) {
			$url = wc_get_page_permalink( 'compare' );
		}

		$martfury_data['added_to_compare_notice'] = array(
			'added_to_compare_text'    => esc_html__( 'has been added to your compare.', 'martfury' ),
			'added_to_compare_texts'   => esc_html__( 'have been added to your compare.', 'martfury' ),
			'compare_view_text'        => esc_html__( 'View Compare', 'martfury' ),
			'compare_view_link'        => esc_url( $url ),
			'compare_notice_auto_hide' => intval( martfury_get_option( 'compare_notice_auto_hide' ) ) > 0 ? intval( martfury_get_option( 'compare_notice_auto_hide' ) ) * 1000 : 0,
		);
	}
